...
import com.b3.cripto.config.EmbeddedKafka;
...
class CriptoKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/cripto-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
